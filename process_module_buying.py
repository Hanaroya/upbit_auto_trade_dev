...
def buying_process(trade_factors, sma200, c_rank, t_record, total_am:float, curs, conn):
    ...
    condition1 = t_record['record']['case1_chk'] > 0 and t_record['hold'] == False and trade_factors.iloc[-1]['rsi_K'] > trade_factors.iloc[-1]['rsi_D'] and t_record['rsi'] < 50 and macd_check(trade_factors=trade_factors)
